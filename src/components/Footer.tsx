                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-body-small opacity-90">
                            Educação científica sobre morcegos para promover
                    ...
                    {/* Links */}
                    <div className="space-y-4">
                        <h3 className="text-heading-xs font-bold">
                            Links Rápidos
                        </h3>
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link
                                    to="/"
                                    className="text-body-small opacity-90 hover:opacity-100 hover:text-accent transition-colors"
                                >
                                    Início
                                </Link>
                            </li>
