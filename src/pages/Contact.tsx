    ...
    <div className="min-h-screen pt-16">
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 animate-fade-in">
          <h1 className="text-heading-xl text-white font-bold mb-4">Entre em Contato</h1>
          <p className="text-body-large text-white/90 max-w-2xl mx-auto">
            Estamos aqui para responder suas dúvidas sobre animais peçonhentos
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="animate-slide-up">
              <h2 className="text-heading-m text-primary mb-6">Envie uma Mensagem</h2>
            ...
            <div className="space-y-6 animate-fade-in">
              <h2 className="text-heading-m text-primary mb-6">Informações de Contato</h2>
                  ...
                  >
                    <CardContent className="p-6 flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-body-medium font-semibold mb-1">{info.title}</h3>
                        {info.link ? (
                          <a
                            href={info.link}
                          ...
                          <p className="text-body-medium text-muted-foreground">{info.content}</p>
                        )}
                      </div>
                    </CardContent>
                  </Card>
              ...
              <Card className="border-0 shadow-md bg-accent-light/30 mt-8">
                <CardContent className="p-6">
                  <h3 className="text-heading-xs text-primary mb-3">Precisa de Ajuda Imediata?</h3>
                  <p className="text-body-medium text-muted-foreground mb-4">
                    Em caso de acidente com animal peçonhento, procure atendimento médico imediatamente. Ligue para:
                  </p>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 animate-fade-in">
            <h2 className="text-heading-m text-primary mb-4">Nossa Localização</h2>
            <p className="text-body-large text-muted-foreground">
              Encontre-nos em São Paulo, Brasil
            </p>
          </div>

          <div className="rounded-2xl overflow-hidden shadow-lg h-[400px] animate-scale-in">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14628.951562148943!2d-46.63291!3d-23.5505!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce5a2b2ed7f3a1%3A0xab35da2f5ca62674!2sSão%20Paulo%2C%20SP!5e0!3m2!1spt-BR!2sbr!4v1234567890"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
      ...
      <section className="py-20 bg-gradient-primary text-primary-foreground">
        <div className="container mx-auto px-4 sm:px-6 text-center animate-fade-in">
          ...
          <p className="text-body-large mb-8 max-w-2xl mx-auto opacity-90">
            Confira nossa seção de perguntas frequentes na página de Outros Animais para encontrar respostas rápidas
          </p>
        </div>
      </section>
    </div>
